													...
													<div class="card-body ">
														...
														<div class="table-scrollable">
															...
															<table
																...
																<tbody>
																	@foreach($datastorage as $studentinfo)
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="assets/img/std/std1.jpg"
																				alt="">
																		</td>
																		<td class="left">{{ $studentinfo->id }}</td>
																		<td>{{ $studentinfo->Username }}</td>
																		<td class="left">{{ $studentinfo-> Firstname }}</td>
																		<td class="left">{{ $studentinfo-> Lastname }}</td>
																		<td class="left">{{ $studentinfo-> Address }}</td>
																		<td><a href="tel:4444565756">
																				{{ $studentinfo->Phone }} </a></td>
																		<td><a href="https://radixtouch.com/cdn-cgi/l/email-protection#a5d6cdd0ddc0d7e5c2c8c4ccc98bc6cac8">
																				<span class="__cf_email__" data-cfemail="7200131817011a32151f131b1e5c111d1f">{{ $studentinfo->Email }}</span> </a></td>
																		<td class="left">22 Feb 2010</td>
																		<td>
																			<a href="{{'AdminEditForm/'.$studentinfo->id}}"
																				class="btn btn-primary btn-xs">
																				<i class="fa fa-pencil"></i>
																			</a>

																			<a href="{{'delete/'.$studentinfo->id}}"
																	...
																	<tr class="odd gradeX">
																		...
																		<td><a href="tel:4444565756">
																				4444565756 </a></td>
																		<td><a href="https://radixtouch.com/cdn-cgi/l/email-protection#a5d6cdd0ddc0d7e5c2c8c4ccc98bc6cac8">
																				<span class="__cf_email__" data-cfemail="7200131817011a32151f131b1e5c111d1f">[email&#160;protected]</span> </a></td>
																		<td class="left">22 Feb 2010</td>
																		<td>
																			<a href="edit_professor.html"
																				class="btn btn-primary btn-xs">
