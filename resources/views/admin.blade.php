						...
						<ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
							...
							<li class="nav-item">
								...
								<ul class="sub-menu">
									...
									<li class="nav-item">
										<a href="lockscreen" class="nav-link "> <span class="title">Lock
												Screen</span>
										</a>
									</li>
							...
							<div class="blogThumb">
								...
								<div class="course-box">
									...
									<div class="text-muted"><span class="m-r-10">January 1</span>
										<a class="course-likes m-l-10" href="#"><i class="fa fa-heart-o"></i> 10</a>
									</div>
							...
							<div class="blogThumb">
								...
								<div class="course-box">
									...
									<div class="text-muted"><span class="m-r-10">April 23</span>
										<a class="course-likes m-l-10" href="#"><i class="fa fa-heart-o"></i> 15</a>
									</div>
							...
							<div class="blogThumb">
								...
								<div class="course-box">
									...
									<div class="text-muted"><span class="m-r-10">May 16</span>
										<a class="course-likes m-l-10" href="#"><i class="fa fa-heart-o"></i>20</a>
									</div>
									<p><span><i class="ti-alarm-clock"></i> Duration: Until Course End</span></p>
							...
							<div class="blogThumb">
								...
								<div class="course-box">
									...
									<div class="text-muted"><span class="m-r-10">September 5</span>
										<a class="course-likes m-l-10" href="#"><i class="fa fa-heart-o"></i> 54</a>
									</div>
									...
									<div class="table-wrap">
										<div class="table-responsive">
											<table class="table display product-overview mb-30" id="support_table">
												...
												<tbody>
													@foreach($datastorage as $applicantinfo)

													<tr>
														<td>{{ $applicantinfo->Id }}</td>
														<td>{{ $applicantinfo->StudentName }}</td>
														<td>{{ $applicantinfo->ProgrameName }}</td>
														<td>27/05/2016</td>
														<td>{{ $applicantinfo->ProgrameCost }}</td>
														<td>{{ $applicantinfo->ApplicantStatus }}</td>
														<td>
															<span class="label label-sm label-success">paid</span>
														</td>
														<td><a href="{{'AdminApplicantEditForm/'.$applicantinfo->Id}}" class=""
																data-bs-toggle="tooltip" title="Edit"><i
																	class="fa fa-check"></i></a>
															<a href="{{'delete/'.$applicantinfo['Id']}}" class="text-inverse"
